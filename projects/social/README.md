...
-   You will need to call add_friendship() 500 times (num_users \* avg_friends // 2). This is because the path for friend relationships is bidirectional and the `add_friendship()` creates both friendship paths.

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?

-   The percentage of other users will be in a particular user's extended social network will be ~99.1%. See `calc_network_percentage` function in social.py.
-   The average degree of separation between a user and those in his/her extended network is 5.5. See `calc_avg_degree_separtation` in social.py.
